 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/af-2.3.2/b-1.5.4/b-colvis-1.5.4
 *
 * Included libraries:
 *   DataTables 1.10.18, AutoFill 2.3.2, Buttons 1.5.4, Column visibility 1.5.4
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.18/af-2.3.2/b-1.5.4/b-colvis-1.5.4",
